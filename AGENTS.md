...
- `MainWindow.xaml.cs` has a reviewed 564-line no-growth baseline (reduced from 616
  after the September 12 search and navigation layout extractions). Respect the
