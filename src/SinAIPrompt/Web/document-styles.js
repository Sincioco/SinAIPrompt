...
export const modernStyles = [
  ...
  {id:'heading',name:'Heading',tag:'h1',next:'normal',css:{...modernHeading,fontSize:'32px',marginTop:'1.75em'}},
  {id:'heading2',name:'Heading2',tag:'h2',next:'normal',css:{...modernHeading,fontSize:'24px',marginTop:'1.7em'}},
  {id:'title',name:'Title',tag:'p',next:'normal',css:{...modernHeading,fontSize:'32px',marginTop:'0'}}
];
